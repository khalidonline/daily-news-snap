...
Preserve Telegram review and existing delivery validation. Snapchat publishing remains disabled. Preserve the shared $3 daily ceiling; avoid unnecessary paid production runs. Reuse verified research within the event window, not repeated published copy.
...
- Existing budget guards, paid-call bounds, Telegram review, and disabled Snapchat publishing remain effective.
