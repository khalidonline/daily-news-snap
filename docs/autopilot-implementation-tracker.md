...
- Independent review caught cross-provider duplication: a Commons thumbnail and Met original could have different hashes. Added official Met source-link canonicalization and a regression with different bytes. 34 focused source/integration tests pass. PR #230 merged as d6f5f489bcf552c02f22924794b4b901f8fa0abc after CI run 35519041531/job 106099804693 passed full v2 checks, actual layout checks, offline evaluation and isolated container. Independent follow-up review found no blockers.
...
- Additional retrieval follow-up: Burst coffee collection (https://www.shopify.com/stock-photos/coffee) exposes varied contemporary coffee images via the web tool; direct programmatic requests to that page and StockSnap Riyadh search returned HTTP403. No circumvention attempted and neither adapter activated. This is not proof those suppliers lack suitable photos; current automated access remains unverified.
- Completed checkpoint: The Met production recovery integration is merged, with no paid end-to-end run or new public post. New engine code still requires fresh qualified shadow evidence before autonomous promotion. Next implementation target is another source only after actual topic coverage and permitted programmatic retrieval are demonstrated; celebrity/event coverage remains an open gate.


### Modern editorial supplier decision checkpoint
- Continued actual terms review beyond prior suppliers: Dreamstime requires visible editorial credits and prohibits automated site search/retrieval without separate authorization; Depositphotos requires all possible/reasonable credit efforts for editorial files. DVIDS distinguishes government and third-party works and contains non-endorsement display provisions; not blanket-approved for no-visible-notice use. Sources and actionable acceptance requirements are in docs/editorial-image-supplier-requirements.md.
- Prepared an unsent supplier inquiry covering no-visible-credit editorial Snapchat rights, authorized API acquisition, third-party AI inference permission, temporary photo processing, 3 distinct actual samples per topic, and pricing tiers. No supplier contact, account signup, purchase or paid run performed.
- No newly verified modern-celebrity source was found in this checkpoint. This is not a claim that none exists. The next concrete dependency for this procurement route is the owner's latest Getty correspondence/quote or authorization and a connected correspondence channel for approaching a supplier. Do not keep promising a standard paid stock subscription solves the requirements.
- Met remains the completed new integration; no source-repeat fallback, source-card publication or engine readiness promotion.


### Visible image attribution implementation — 2026-09-20
- Owner explicitly accepts visible source/photographer credits, superseding all earlier no-visible-credit restrictions. Private editorial/source card remains review-only and never publishes. No repeated photo within a story, including alternate crops/provider copies.
- Implemented CC BY 2.0/4.0 public eligibility using complete bounded attribution metadata. Rights are drawn into a separate bottom band on each editorial JPEG; complete original content and footer logos are retained with proportional scaling. Long notices fail closed rather than being truncated. CC BY-SA/NC/ND are not newly enabled.
- Metadata identity and rendered JPEG hashes bind the public attribution receipt. Both automatic and manual delivery verify the bytes before upload. Manual delivery now also enforces the existing source-image variety guard.
- Commons CC BY can enter the public image pool. Flickr CC0 remains available, with a distinct bounded CC BY recovery stage. No duplicate BY search in review mode; existing subject, origin, hash and download limits remain.
- Independent review requested; final CI/merge receipt to follow. Tests cover real Renderer through both mocked delivery routes, private-source-card exclusion, tampered output, duplicate photos, unsupported/incomplete rights, layout overflow and public Flickr recovery. No real Snapchat request or paid AI run.
- Capacity limitation retained: complete private review credits must also fit their existing page. Excessive package-level notices hold for different image selection rather than dropping attribution. New engine still needs a fresh qualified shadow package before autonomous readiness.

- COMPLETED: PR #231 merged as 733f64c55252e66177ba491d477db7508bcfff45. CI 35520510013/job 106103659014 passed 266 v2 tests, offline evaluation and isolated container. Independent follow-up review found no remaining publication-safety blockers; aggregate credits capacity is documented above.
- Live bounded Flickr check of old Salah photo 29044867267 returned HTTP404; not a verified currently downloadable image. No permanent photos, paid AI or actual publication. Next checkpoint: fresh relevant distinct-image package with complete visible rights, then existing review/readiness gates within authorized budget.

### Fresh Saudia review package — 2026-09-20
- Owner requested preparation after credit-support merge. Prepared one assistant-directed package: info on the 1947 Jeddah–Riyadh–Hofuf–Dhahran route, story on the 1945 DC-3 gift to King Abdulaziz, and the transition to scheduled passenger service. Trigger: reported Jeddah National Day airshow continuing through 20 September with Saudia participation (Saudi Gazette article 664689); historical facts checked against Saudia encyclopedia entry.
- Three distinct images downloaded and rendered through the new production Renderer: Commons 138210967 (Saudia 777, Meshari Alawfi, CC BY4.0), 552663 (King Abdulaziz 1945, public domain), 151123761 (Saudia 787, Ian Gratton, CC BY2.0). Modern aircraft are contextual illustrations, not images of the 1945 gift or today's specific display. Original photos were temporary only.
- Final review PDF contains exactly 3 editorial pages. Separate fourth source/rights card retained for private review; publication_indices returned [0,1,2]. Actual JPEG credit receipts and source-photo variety validated; PDF pages visually inspected. Draft remains approved=false; no Snapchat/Telegram delivery and no autonomous qualification claimed.
- No workflow dispatched and no paid AI calls. Shared daily spend checked at $3.548535; existing temporary $5 daily-shadow allowance not consumed further. Browser workflow form was opened only.
- Sourcing limitation observed: generic Mohamed Salah search still returned a wrong-person Flickr image (Medhat Mohamed Salah); it was explicitly rejected by the assistant and not used. Do not treat metadata substring matches as final visual identity approval. Saudia content was prepared directly rather than misrepresenting an autonomous run as successful.
- Next owner step: review this fresh package. Next system checkpoint remains independent end-to-end shadow qualification; no automatic publishing readiness promotion.

## Exact owner-design API delivery — 2026-09-21
- User authorized continuing the staged transition to autonomy after publishing today's five fireworks cards. They were sent through Bundle UI and all five reported POSTED; they must not be resent to prove API delivery.
- Ruling: complete the bounded missing manual-original-artwork adapter first, then one fresh daily shadow trial. Existing autonomous renderer/publisher already connect; do not rebuild them or equate manual artwork validation with autonomous readiness.
- Added a distinct owner-generated-design-v1 manifest for trusted repository authoring after the owner reviews exact ChatGPT-generated illustrations. It binds ordered hashes to an owner-review reference and records Library provenance. These records are owner attestation, not an API ownership verification. Third-party/reference images stay on the licensed-image path.
- Preserves PNG bytes and the existing delivery identity; checks expiry, account, path containment, PNG decode/aspect, duplicate provenance and duplicate media. No model is given authority to create an owner approval; autonomous publication still rejects these records.
- Added validate CLI/workflow mode with no publishing credentials or provider/journal calls. Real fireworks originals passed local validation as five exact files; no publication was attempted and their assets/manifest are deliberately not committed for re-delivery.
- Tests: eight new owner-design cases demonstrated RED before implementation and GREEN afterwards. Initial full suite exposed renderer_configuration_mismatch when run without the established Almarai/light environment. CI already sets it; the autopilot preflight did not. Added the same explicit environment to that preflight and rerunning the configured suite.
- Shared cap remains $3/day. Latest observed readiness records are for earlier engines and do not qualify current autonomous posting. Today's ledger path returned 404; any paid run must still successfully reserve in the shared ledger before calling a model.
- Implementation and review underway; deployment and live qualification evidence to follow.
- Verification complete: configured Almarai/light suite passed 274 tests; offline evaluation returned offline_ready. Fresh independent review reported no blockers/important issues and independently passed 18 focused delivery tests. No source rights or autonomous review gate was weakened.

### Deployment and fresh shadow result — 2026-09-21
- Owner explicitly approved push/merge to khalidonline/daily-news-snap and one daily shadow trial within $3. PR #232 merged as 9eafe4c775f1f52d0c72f6c4a2bfc82bd33663fa after successful offline workflow 35578504984; uploaded final tree exactly matched locally tested tree 613a7ece25f86b0d495cffe91b451163f62d8561.
- Dispatched daily/shadow once on main: run 35578655764, engine d5b6f8d6edbbaddbdeec7f6479ea5f3ffb317deee4900ae4358dcf6376d53e93. Preflight passed; editorial generation ended held/no_package_passed_review. No new cards or posts were produced. Operational Telegram report and artifact upload succeeded.
- Shared ledger daily/2026-09-21.json has one settled editor call: $0.067886, no outstanding reservation, cap $3. No second paid attempt was made.
- Four candidate rejections: insufficient_subject_visuals_before_drafting; editor_subject_evidence_mismatch; editor_subject_quote_not_in_source; editor_subject_evidence_mismatch. The final persisted Jeddah candidate used subjects=[Roshn Front (Jeddah)] but evidence.subject=Roshn Front, Jeddah, proving a model output consistency failure under the strict binding contract. Its quote also reformatted spaces around punctuation; why_now said today although the source was dated yesterday. Do not bypass evidence/timing checks to force qualification.
- Next bounded work: remove duplicated model-authored subject identity fields through a source-bound structured selection contract, preserve verbatim source evidence, and test relative-date wording. Then establish adequate distinct relevant image coverage before another end-to-end paid qualification. No claim that autonomous design matches manually approved artwork has been established by this held run.
- Current readiness remains NOT QUALIFIED for unattended production: both daily and local require recent passes on the current engine. Manual exact-design API adapter is deployed; autonomous editorial/image generation remains the outstanding gate.
