# First Info preview — 12 September 2026

This bounded preview turns today's NASA APOD editorial feature into an Arabic Info card about Apollo 11 collecting solar-wind particles with foil. The source event is explicitly historical (1969); the current trigger is the daily feature, not a new lunar landing or discovery.

Source: https://apod.nasa.gov/apod/ap260912.html
Image: AS11-40-5872, Neil Armstrong / NASA, scan by Kipp Teague.
Rights context: https://www.nasa.gov/nasa-brand-center/images-and-media/
Use is informational/editorial with photo acknowledgment, without endorsement or advertising. No blanket approval of other NASA or third-party assets is inferred.
...
Current scope is one Info card. Topic and the six-frame Story package, provider comparison, production recovery and the three-day live trial remain separate unfinished work.
