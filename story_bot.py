...
6. الحكم — القصة تنتهي بحكم واضح، لا بسؤال مفتوح.
   ...
   وإن كان في القصة تراجع أو ثمن ما زال قائماً، فاذكره تابعاً لا معادلاً:
   جملة ثانوية داخل الحكم، لا فقرة توازيه. اللقطة التي تمنح النجاح والفشل
   وزناً واحداً لا تُنهي القصة، بل تتركها معلّقة.
