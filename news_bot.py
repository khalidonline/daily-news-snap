...
- المشاهير والفن
- الرياضة، باستثناء نتيجة مباراة دوري روشن كما هو موضح أدناه
...
2. إن لم تكتمل {n}، أضف أهم أخبار الشرق الأوسط.
3. إن لم تكتمل بعد، أضف أهم أخبار العالم.
4. يجوز أن يكون أحد الأخبار نتيجة مباراة حديثة من دوري روشن السعودي للمحترفين، \
بخبر واحد كحد أقصى، وبشرط أن تكون المباراة قد أُقيمت فعلاً وورد ذكرها في العناوين.

يجب أن تعيد {n} أخبار بالضبط. المعيار يبقى صارماً داخل كل مستوى: وسّع النطاق \
الجغرافي، ولا تخفض مستوى الأهمية. أي لا تضع خبراً سعودياً ضعيفاً بدلاً من خبر \
عالمي مهم.

رتّب الأخبار في القائمة: السعودية أولاً، ثم الإقليمية، ثم العالمية، ونتيجة \
المباراة في آخر القائمة إن وُجدت.
