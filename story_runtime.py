...
_CURATED_FRAME_VISUALS = {
    ...
    "قصة أزمة 2008: كيف بدأت وكيف انتهت؟": (
        ...
        (("15 سبتمبر: سقوط بنك عملاق", "سقوط ليمان براذرز", "ليلة انهيار ليمان"), "lehman-2008.jpg"),
        (("الثمن: ملايين بلا وظائف", "ثمن الذعر", "ثمن الانهيار"), "targeted-2008-nyse-trading-floor.jpg"),
        (("خطة الإنقاذ الكبرى", "من القاع إلى القمة", "خطة الإنقاذ الحكومية"), "targeted-2008-wall-street-october.jpg"),
        (("ما لم يعد كما كان", "القواعد التي تغيّرت", "الأثر الذي لم يُمحَ"), "targeted-2008-nyse-oct23.jpg"),
    ),
    ...
    "علي النعيمي: من صبي في أرامكو إلى وزير يحرّك أسواق النفط": (
        (("بادية بلا مدارس",), "aramco-1935-hufof.jpg"),
        (("الصبي الذي حلّ محل أخيه",), "aramco-1951-camp.jpg"),
        (("الشركة أرسلته يتعلّم",), "aramco-1951-car.jpg"),
        (("الاجتماع الذي هزّ الأسعار",), "ali-alnaimi-2010-bilateral.jpg"),
        (("خرج من الوزارة واسمه بقي",), "ali-alnaimi-2005-india.jpg"),
        (("الباب الذي فتحه",), "ali-alnaimi.jpg"),
    ),
    "من هم أول الموظفين السعوديين في أرامكو؟": (
        (("البئر السابعة تتدفق",), "aramco-dammam-well-7.jpg"),
        (("صبي ينقل الأوراق",), "ali-alnaimi.jpg"),
